...
namespace Senado
{
    public partial class FrmSenado : Form
    {
        ...
        public void FinCambioPresentismo()
        {
            if (InvokeRequired)
            {
                Invoke(new Action(FinCambioPresentismo));
            }
            else
            {
        ...
        public void FinalizaVotacion()
        {
            ...
            else
            {
                ...
                lblAbstenciones.Text = this.parlamento.VotoAbstenciones.ToString();
                MetodoSQL.GuardarResultado(parlamento);
            }

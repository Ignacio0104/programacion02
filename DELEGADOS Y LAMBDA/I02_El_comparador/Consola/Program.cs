...
namespace Consola
{
    class Program
    {
        ...
        //DelegadoComparacion delegadoComparador = (palabraUno, palabraDos) => palabraUno.CompareTo(palabraDos);
        ...
        public static void Comparar(string primerPalabra,string segundaPalabra, DelegadoComparacion delegado)
        {
            if (delegado(primerPalabra, segundaPalabra) > 0)
            {
